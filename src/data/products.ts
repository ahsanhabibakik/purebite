...
export const products: Product[] = [
  // Homemade Healthy Snacks & Sweets
  {
    ...
    originalPrice: 400,
    discount: 12,
    images: ["/products/dates-almond-halwa.jpg"],
  ...
  },
  {
    ...
    price: 250,
    images: ["/products/sesame-laddu.jpg"],
    category: ProductCategory.HOMEMADE_SNACKS,
  ...
  },
  {
    ...
    price: 450,
    images: ["/products/energy-balls.jpg"],
    category: ProductCategory.HOMEMADE_SNACKS,
  ...
  },
  {
    ...
    price: 180,
    images: ["/products/date-jaggery.jpg"],
    category: ProductCategory.DRY_FOODS,
  ...
  // Fresh Products  
  {
    ...
    price: 1800,
    images: ["/products/hilsa-fish.jpg"],
  ...
  },
  {
    ...
    price: 15,
    images: ["/products/deshi-eggs.jpg"],
    category: ProductCategory.FRESH_PRODUCTS,
  ...
  // Gift Combos
  {
    ...
    originalPrice: 1000,
    discount: 15,
    images: ["/products/healthy-combo.jpg"],
